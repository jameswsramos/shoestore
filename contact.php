      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <p class="breadcrumb-custom"><a href="index.html">Beranda</a> <span class="mx-2">&gt;</span> <span>Kontak</span></p>
          </div>
        </div>
      </div>
    </div>  
...
?>
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p><a href="#" class="btn btn-primary px-4 py-2 text-white">Pelajari Lebih Lanjut</a></p>
            </div>
